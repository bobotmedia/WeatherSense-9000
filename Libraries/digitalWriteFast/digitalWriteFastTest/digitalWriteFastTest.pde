...
delay(10);
if((byte) digitalReadFast(52) != LOW) error(52,53,1);
...
delay(1);
if((byte) digitalReadFast2(52) != LOW) error(52,53,1);
...
delay(1);
if((byte) digitalReadFast(53) != LOW) error(53,52,2);
...
delay(10);
if((byte) digitalReadFast2(53) != LOW) error(53,52,2);
...
digitalWriteFast2(53,HIGH);
delay(10);
if(HIGH != ((int) digitalReadFast2(52)) ) error(52,53,4);
