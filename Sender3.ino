...
// ******* DEFINE CONSTANTS *******
#define SLEEP_TIME_DUR 1980  //sleep time in seconds (best if multiple of 8)
...
void setup(void)
{
  ...
  payload.sender_id = 2;   //which sending device is this?
...
//    Serial.println(tx_counter);
    ...
    // if first time through this sketch, tell receiver to reset it's rx_counter too
    if (first) {
